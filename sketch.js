...
Garbage,upload,download,blue,white,green,sprite,wires;
var crew,crew1;
var imposter;
var edges;
...
function setup(){
  ...
  var green = createSprite(200, 340,10,10);
...
// green.rotation = 180;
//green.scale = 1;
//green.rotateToDirection=true;

////green.rotation=green.rotation+5;
...
edges = createEdgeSprites();
 ...
 //crew.collide(Emergency);
  //imposter.bounceOff(sprite);
